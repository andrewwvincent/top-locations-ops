const config = {
    ...
    defaultColors: {
        ...
        '500k': {
            '1500+': 'rgba(102, 0, 153, 0.85)',         // Dark purple
            '1250-1500': 'rgba(186, 85, 211, 0.85)',   // Medium purple
            '1000-1250': 'rgba(220, 20, 60, 0.85)',    // Deep red
            '750-1000': 'rgba(255, 140, 0, 0.85)',     // Dark orange
            '500-750': 'rgba(255, 215, 0, 0.85)',      // Gold
            '0-500': 'rgba(255, 255, 224, 0.85)'      // Light yellow
        }
    }
};
